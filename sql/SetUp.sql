...
insert into users values
	...
	(default, 'tom', 'tom', 'tom', 'tom', 'tom@email.com', 2),
	(default, 'bob', 'bob', 'bob', 'bob', 'bob@email.com', 2);
...
insert into reimbursement values 
	...
	(default, 80.00, '10/18/2020 07:32:21', '10/18/2020 07:32:21', 'replaced company car keys that I lost', null, 3, 1, -1, 4),
	(default, 60.00, '10/18/2020 10:37:43', '10/18/2020 10:37:43', 'purchased office supplies', null, 4, 2, 1, 4);
...
table(id int, author_id int, resolver_id int, amount numeric, submitted timestamp,
		resolved timestamp, description text, receipt bytea, status_id int, type_id int)
as $$
	begin
		return query select r.id, r.author, r.resolver, r.amount, r.submitted, r.resolved,
...
insert into users values (default, 'joon', 'joon', 'joon', 'joon', 'joon@email.com', 2),
						(default, 'sarah', 'sarah', 'sarah', 'sarah', 'sarah@email.com', 2),
					(default, 'caleb', 'caleb', 'caleb', 'caleb', 'caleb@email.com', 2);
